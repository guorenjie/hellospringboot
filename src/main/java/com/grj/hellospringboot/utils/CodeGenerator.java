package com.grj.hellospringboot.utils;
...
public class CodeGenerator {
    ...
    // 包配置-父包名
    private static String parent = "com.grj.hellospringboot";
    //数据源配置
    ...
    public static void main(String[] args) {
        ...
        generator(author,parent,dataSourceDriverClassName,dataSourceUrl,dataSourceUsername,dataSourcePassword);
     ...
     */
    public static void generator(String author,String parent,String dataSourceDriverClassName,String dataSourceUrl,String dataSourceUsername,String dataSourcePassword){
        // 代码生成器
